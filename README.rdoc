...
KickIt is an unofficial Ruby wrapper for the {Kitdigital}[http://www.kitd.com]
...
Think something like {DISQUS}[http://disqus.com/] but with a more robust feature set. 
...
use this library.  You can write this configuration in Ruby like so:
...
By default, the command line scripts under +bin/+ automatically requires
a +kickit_config.rb+ file.  There is a sample +kickit_config.rb+ file under
